    ...
    while True: #วนซ้ำจนกว่าจะเจอคำสั่ง break 
      while True: #วนซ้ำจนกว่าจะเจอคำสั่ง break  
        ...
        if zipcode in provincedata : #ถ้าเลขไปรษณีย์อยู่ใน provincedata 
            ...
            print("หมายเลขไปรษณี {} ตำบล{} อำเภอ{} จังหวัด{} ใช่หรือไม่".format(zipcode, provincedata[zipcode]['district'],provincedata[zipcode]['amphoe'], provincedata[zipcode]['province']))#แสดงข้อความ หมายเลขไปรษณี... ตำบล... อำเภอ... จังหวัด... ใช่หรือไม่" 
            try: #ตรวจหาError
            ...
            print("หมายเลขไปรษณีไม่ถูกต้อง กรุณาลองใหม่อีกครั้ง") #แสดงข้อความ หมายเลขไปรษณีย์ไม่ถูกต้อง กรุณาลองใหม่อีกครั้ง
